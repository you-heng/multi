    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="is_open">
                {{# if(d.open == 1){ }}
                <a class="layui-btn layui-btn layui-btn-xs">开启刷单中</a>
                {{# }else if(d.open == 2){ }}
                <a class="layui-btn layui-btn-disabled layui-btn-xs">已关闭刷单</a>
                {{# } }}
            </script>
            ...
            <script type="text/html" id="table-useradmin-webuser">
                {{# if(d.open == 1){ }}
                <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="open">关闭</a>
                {{# }else if(d.open == 2){ }}
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field: 'open', title: '开启刷单', templet: '#is_open'}
        ...
        table.on('tool(LAY-user-manage)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                let msg = '开启';
                console.log(data);
                if(data.open == 1){ msg = '关闭' }
                layer.confirm('真的' + msg + '刷单吗', function (index) {
                    data.type = 5;
                    admin.req({
                        url: 'api/shop-form.php',
                        type: 'post',
                ...
                layer.open({
                    ...
                    ,success: function(layero, index){
                        ...
                        body.contents().find("#shop_name").val(data.shop_name);
                    }
                });
            }
        });
