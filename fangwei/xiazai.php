    ...
    <div class="xiazai">
        <div class="xiazai_one">
            ...
            <div>
                <span>请点击这里</span>
                <span>-></span>
                <span class="xiazai_one_xiazai" onclick='location="app/baicao1.0.apk"'>下载APP</span>
            </div>
        </div>
        ...
        <div class="xiazai_three">
            <p>不懂怎么下载？</p>
            <p>可以点击这里查看<span class="xiazai_three_click" onclick='location="jiaocheng2.php"'>视频教程</span></p>
        </div>
