...
class PddWmsOuborderCreateRequest_RequestOrderLineItem extends PopBaseJsonEntity
{
	...
	*/
	...
	/**
	* @JsonProperty(String, "targetWareSn")
	*/
	private $targetWareSn;
	...
	public function setTargetWareSn($targetWareSn)
	{
		$this->targetWareSn = $targetWareSn;
	}
