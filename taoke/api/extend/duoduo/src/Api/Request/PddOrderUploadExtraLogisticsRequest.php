...
class PddOrderUploadExtraLogisticsRequest extends PopBaseHttpRequest
{
	...
	*/
	...
	/**
	* @JsonProperty(Integer, "extra_track_type")
	*/
	private $extraTrackType;

	protected function setUserParams(&$params)
	{
		$this->setUserParam($params, "extra_track_list", $this->extraTrackList);
		$this->setUserParam($params, "order_sn", $this->orderSn);
		$this->setUserParam($params, "extra_track_type", $this->extraTrackType);
	...
	public function setExtraTrackType($extraTrackType)
	{
