...
<div class="login layui-anim layui-anim-up">
    <div class="message">论文管理系统学生注册</div>
    ...
    <form method="post" class="layui-form" >
        ...
        <hr class="hr15">
        <input value="注册" lay-submit lay-filter="register" style="width:100%;" onclick="return false;" type="submit">
        <hr class="hr20" >
    </form>
</div>
    ...
    $(function  () {
        layui.use('form', function(){
            ...
            form.on('submit(register)', function(data){
                $.post('./api/register.php',{data:data.field},(res)=>{
