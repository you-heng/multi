...
<div class="container">
    <div class="logo">
        <a href="./index.html">缺陷管理系统</a></div>
    <div class="left_open">
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a href="javascript:;">
                    <i class="layui-icon iconfont left-nav-li" lay-tips="用户管理">&#xe770;</i>
                    <cite>用户管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i>
                </a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('用户','../admin-list.php')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户</cite>
                        </a>
                    </li>
            ...
            <li>
                <a href="javascript:;">
                    <i class="layui-icon iconfont left-nav-li" lay-tips="项目管理">&#xe61d;</i>
                    <cite>项目管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i>
                </a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('项目','../project-list.php')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>项目</cite>
                        </a>
                    </li>
